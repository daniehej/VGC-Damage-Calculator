...
var POKEDEX_TEMP = $.extend(true, {}, POKEDEX_XY, {
...
delete POKEDEX_TEMP['Gengar'].ab;
delete POKEDEX_TEMP['Raikou'].ab;
delete POKEDEX_TEMP['Entei'].ab;
delete POKEDEX_TEMP['Suicune'].ab;
...
for (var i = 0; i < Object.keys(SMDEX).length; i++) {
  var foo = Object.keys(SMDEX)[i];
  SMDEX[foo] = POKEDEX_TEMP[foo];
};

var dexSelect = getUrlParameter('fulldex')

if (dexSelect == "true"){
  var POKEDEX_SM = POKEDEX_TEMP;
}
else{
  var POKEDEX_SM = SMDEX;
}
